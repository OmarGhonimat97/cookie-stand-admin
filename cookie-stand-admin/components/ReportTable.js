...
export default function ReportTable() {
  ...
  if (resources) {
    ...
    for (let i in hours) {
      ...
      hr_tot.push(hr.reduce((p, c) => p + c, 0))
    }
        ...
        <tbody>
          {resources.map(loc =>
            <tr key={loc.id}>
              ...
              <td>{Math.floor(Math.random() * (loc.maximum_customers_per_hour - loc.minimum_customers_per_hour) + loc.minimum_customers_per_hour)}</td>
              <td>{Math.floor(Math.random() * (loc.maximum_customers_per_hour - loc.minimum_customers_per_hour) + loc.minimum_customers_per_hour)}</td>
              <td>{Math.floor(Math.random() * (loc.maximum_customers_per_hour - loc.minimum_customers_per_hour) + loc.minimum_customers_per_hour)}</td>
              <td>{Math.floor(Math.random() * (loc.maximum_customers_per_hour - loc.minimum_customers_per_hour) + loc.minimum_customers_per_hour)}</td>
              <td>{Math.floor(Math.random() * (loc.maximum_customers_per_hour - loc.minimum_customers_per_hour) + loc.minimum_customers_per_hour)}</td>
